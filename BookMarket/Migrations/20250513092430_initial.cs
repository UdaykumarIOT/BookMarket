        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PubId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PubName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Address = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PubId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PubDate = table.Column<DateOnly>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CartItems_Titles_TitleId",
                        column: x => x.TitleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderItems_Titles_TitleId",
                        column: x => x.TitleId,
                        principalTable: "Titles",
                        principalColumn: "TitleId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "100", 0, null, "6e39b0a2-f86b-43f3-8fa6-10c4e2030a83", new DateTime(2025, 5, 13, 9, 24, 27, 753, DateTimeKind.Utc).AddTicks(7210), "admin@bookmarket.com", true, null, null, false, null, "ADMIN@BOOKMARKET.COM", "ADMIN@BOOKMARKET.COM", "AQAAAAIAAYagAAAAEHIm51DckeYns3DNpk6l0NzQz7z4F/scI6hiXB3T5IBA5Pvmt2PZEkK1diDhBeMSpw==", null, false, "12345678-90ab-cdef-1234-567890abcdef", false, "admin@bookmarket.com" });
